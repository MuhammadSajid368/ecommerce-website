...
const HorizontalCardProduct = ({ categorey, heading }) => {
  ...
  return (
    <div className='container mx-auto px-5 my-6 mb-11'>
      ...
      <div className='relative'>
              ...
              return (
                <Link to={`product/${product._id}`} key={index} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
                  <div className='bg-slate-200 h-full p-4 min-w-[120px] md:min-w-[145px] flex items-center justify-center'>
                    <img src={product.productImage[0]} alt="" className='h-full object-scale-down hover:scale-110 transition-all' />
                  </div>
                  <div className='flex flex-col justify-between p-2 flex-grow'>
                    ...
                    <div className='mt-2'>
                      ...
                      <button
                        className={`mt-2 bg-red-600 hover:bg-red-700 text-white px-3 py-0.5 rounded-full text-sm ${product.stock === 0 ? 'opacity-50 cursor-not-allowed' : ''}`}
        ...
        <button
          className='bg-white shadow-md rounded-full p-1 absolute left-0 text-lg hidden md:flex items-center justify-center z-10 transition-all duration-300 hover:bg-gray-200'
          onClick={scrollLeft}
        ...
        <button
          className='bg-white shadow-md rounded-full p-1 absolute right-0 text-lg hidden md:flex items-center justify-center z-10 transition-all duration-300 hover:bg-gray-200'
          onClick={scrollRight}
          style={{ top: '50%', transform: 'translateY(-50%)' }}
        >
